...
<body>
	...
	<div class="container"
		...
		<form method="post" action="themloaiadmincontroller" class="add-form"
			enctype="multipart/form-data">
			<h2 style="border-bottom: 1px solid red">Thêm loại</h2>
			<div class="form-group">
				<label>Mã loại:</label> <input type="text" name="txtml" value=""
					class="form-control">
			</div>
			<div class="form-group">
				<label>Tên loại:</label> <input type="text" name="txttl" value=""
					class="form-control">
			</div>
			<div class="form-group">
				<label>Ảnh loại:</label> <input type="file" name="txtfile" value=""
					class="form-control">
			</div>
			<input type="submit" class="cancel btn btn-primary"
				style="padding: 10px 72px 10px 72px; border-radius: 45px; background-color: #fd9b27; border-color: #fc9a26; margin-left: 200px;">
		</form>
	</div>
</body>
<script>
