...
<body>
	...
	<div class="container"
		style="padding: 20px 0px 20px 0px; box-shadow: 0 10px 20px rgb(0 0 0/ 10%); box-sizing: border-box; color: #262626; font-size: 1rem; font-weight: 400; justify-content: space-between; width: 1000px; margin: 80px 205px 80px 205px; box-shadow: 0 10px 20px rgb(0 0 0/ 10%);">
		...
		<div style="display: flex; justify-content: center;">
			<a
				style="text-align: center; background-color: #fd9a26; margin: 6px; border-radius: 13px; display: block; color: #fff; padding: 4px 8px; width: 200px; height: 30px;"
				href="xacnhanadmincontroller?MaHoaDon=${mahoadon }"> Xác nhận </a>
		</div>
	</div>
</body>
