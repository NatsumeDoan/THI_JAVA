...
<body>
	...
	<div class="container"
		...
		<form method="post" action="sualoai" class="add-form"
			enctype="multipart/form-data">
			<h2 style="border-bottom: 1px solid red">Sửa loại</h2>
			<div class="form-group">
				<label>Mã loại:</label> <input type="text" name="txtml"
					value="${maloai }" class="form-control">
			</div>
			<input type="hidden" name="txtmlc" value="${maloai }">
			<div class="form-group">
				<label>Tên loại:</label> <input type="text" name="txttl"
					value="${tenloai }" class="form-control">
			</div>
			<input type="hidden" name="txtfilecu" value="${anhloai }">
			<div class="form-group">
				<label>Ảnh loại:</label> <input type="file" name="txtfile"
					value="${anhloai }" class="form-control">
			</div>
