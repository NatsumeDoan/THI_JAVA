		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="registercontroller" method="post">
					<input class="text" type="text" name="tendn" placeholder="Username" required>
					...
					<input class="text" type="text" name="phone" placeholder="Your number" required>
				...
				<p>Don't have an Account? <a href="logincontroller"> Login Now!</a></p>
				<p style="margin-top: 20px;">Back to <a href="sanphamcontroller">Home</a> page</p>
			</div>
		</div>
		<!-- copyright -->
