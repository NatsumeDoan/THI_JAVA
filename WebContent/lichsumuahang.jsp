				...
				<tbody>
					...
					<c:forEach items="${lsu }" var="l">
						...
						<tr>
							...
							<td data-th="Trạng thái">
								<div class="col-md-9 text-left mt-sm-2">
									<c:if test="${l.isTrangthai()==false}">
										<div class="col-md-9 text-left mt-sm-2">
											<h4>Đang đặt mua</h4>
										</div>
									</c:if>
									<c:if test="${l.isTrangthai()}">
										<div class="col-md-9 text-left mt-sm-2">
											<h4>Đã thanh toán</h4>
										</div>
									</c:if>
							...
							<td data-th="Chi tiết"><a
								href="chitietlichsucontroller?mahd=${l.getMahd() }&tendn=${DangNhap }">xem
									chi tiết</a></td>
					</c:forEach>
