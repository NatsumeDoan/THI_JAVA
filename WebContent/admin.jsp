...
<body>
	...
	<div class="container" style="text-align: center;">
		<div class="container_cf"
			style="text-align: center; padding: 20px 0px 20px 0px; box-shadow: 0 10px 20px rgb(0 0 0/ 10%); box-sizing: border-box; color: #262626; font-size: 1rem; font-weight: 400; justify-content: space-between; width: 1305px; box-shadow: 0 10px 20px rgb(0 0 0/ 10%);">
			<h1 style="margin-bottom: 30px">Xác nhận đơn hàng</h1>
			<table class="table table-condensed table-responsive"
				style="width: 100%">
				<thead>
					<tr>
						<th style="width: 5%">STT</th>
						<th style="width: 7%">Mã hoá đơn</th>
				...
				<tbody>
					...
					<c:forEach items="${dskh }" var="xn">
						<c:set var="j" value="${j+1}"></c:set>
						<tr>
							<td data-th="STT">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${j}</h4>
								</div>
							</td>
							<td data-th="Ngày mua">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${xn.getMahd() }</h4>
								</div>

							</td>
							<td data-th="Tên khách hàng">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${xn.getHoten() }</h4>
								</div>
							</td>
							<td data-th="Ngày mua">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${xn.getDiachi() }</h4>
								</div>

							</td>
							<td data-th="Ngày mua">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${xn.getSdt() }</h4>
								</div>
							</td>

							<td data-th="Ngày mua">
								<div class="col-md-9 text-left mt-sm-2">
									<h4 style="padding-top: 30px;">${xn.getNgaymua() }</h4>
								</div>

							</td>
							<td data-th="Trạng thái"><c:if
									test="${xn.isTrangthai()==false}">
									<div class="col-md-9 text-left mt-sm-2">
										<h4 style="padding-top: 30px;">Dang dat mua</h4>
									</div>
								</c:if> <c:if test="${xn.isTrangthai()}">
									<div class="col-md-9 text-left mt-sm-2">
										<h4 style="padding-top: 30px;">Da thanh toan</h4>
									</div>
								</c:if></td>
							<td style="padding-top: 30px;"><a
								href="xacnhanadmincontroller?MaHoaDon=${xn.getMahd() }"> Xác
									nhận đã chuyển tiền </a></td>
							<td style="padding-top: 30px;"><a
								href="chitietxacnhanadmincontroller?MaHoaDon=${xn.getMahd() }&act=chitiet">
