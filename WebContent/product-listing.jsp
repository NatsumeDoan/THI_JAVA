...
<body>
		...
		<div class="header_controller">
			...
			<div class="nav">
				<ul class="list_nav">
					<li>
						<div class="boxsearch">
							<form class="form_search" action="sanphamcontroller">
								<input type="text" name="timkiem" placeholder="Tìm sản phẩm...">
	...
	<div class="container">
		<div class="container_cf">
			<h1>Sản phẩm Minh Đoàn</h1>
			<div class="header_ctn">
				<div class="list_loai">
					<c:forEach items="${loai }" var="l">
						<div class="loai"
							onclick="location.href='sanphamcontroller?maloai=${l.getMaloai() }'">
							<div class="img-cf">
								<img src="${l.getAnhloai() }" alt="">
							</div>
							<h5>${l.getTenloai() }</h5>
						</div>
					</c:forEach>
			...
			<div class="list_cf">
				<c:if test="${sp1 == 'f' }">
					<div style="justify-content: center; width: 100%;">
						<h1>Không có sản phẩm cần tìm kiếm</h1>
					</div>
				</c:if>
				<c:forEach items="${sp }" var="s">
					<div class="sanpham"
						onclick="location.href='chitietsanphamcontroller?masp=${s.getMasp() }'">
						<div class="img_cf">
							<img src="${s.getAnhsp() }" alt="">
						</div>
						<div class="in4">
							<h2>${s.getTensp() }</h2>
							<div class="gia">
								<h3>${s.getGia() }đ</h3>
								<a href="chitietsanphamcontroller?masp=${s.getMasp() }"><i
