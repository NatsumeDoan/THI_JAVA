...
<body>
	...
	<div class="container"
		...
		<form method="post" action="suasanpham" class="add-form"
			enctype="multipart/form-data">
			<h2 style="border-bottom: 1px solid red">Sửa sản phẩm</h2>
			<div class="form-group">
				<label>Mã sản phẩm:</label> <input type="text" name="txtmsp"
					value="${masp }" class="form-control">
			</div>
			<input type="hidden" name="txtmspc" value="${masp }">
			<div class="form-group">
				<label>Tên sản phẩm:</label> <input type="text" name="txttsp"
					value="${tensp }" class="form-control">
			</div>
			<div class="form-group">
				<label>Đơn giá:</label> <input type="number" name="txtg"
					value="${gia }" class="form-control">
			</div>
			<div class="form-group">
				<label>Loại sản phẩm:</label> <select name="txtml" class="form-select"
					aria-label="Default select example">
					<c:forEach items="${lstLoai }" var="o">
						<option ${maloai == o.maloai?"selected":"" }
							value="${o.maloai }">${o.tenloai }</option>
					</c:forEach>
				</select>
			</div>
			<div class="form-group">
				<label>Mô tả</label> <input type="text" name="txtmt"
					value="${mota }" class="form-control">
			</div>
			<input type="hidden" name="txtfilecu" value="${anhsp }">
			<div class="form-group">
