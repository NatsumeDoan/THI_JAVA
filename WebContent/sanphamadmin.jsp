...
<body>
	...
	<div class="container"
		...
		<div class="container_cf" style="width: 100%;">
			<h1 style="margin-bottom: 20px">Sản phẩm</h1>
								...
								<div class="edit" style="display: flex; padding-left: 60px;">
									<div class="sua">
										<i class="fa fa-pencil"
											onclick="location.href='suasanphamcontroller?msp=${s.getMasp() }&tsp=${s.getTensp() }&anhsp=${s.getAnhsp() }&mota=${s.getMota() }&ml=${s.getMaloai() }&gia=${s.getGia() }'"
											style="cursor: pointer;"></i>
									</div>
									<div class="xoa">
										<i class="fa fa-trash"
											onclick="location.href='sanphamadmincontroller?xoa=${s.getMasp() }'"
	...
	<div class="back">
		<a href="themsanphamcontroller"><i class="fa-solid fa-plus"></i></a>
	</div>
</body>
